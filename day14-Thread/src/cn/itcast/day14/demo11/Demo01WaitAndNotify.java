package cn.itcast.day14.demo11;
/*
* 等待唤醒案例：线程之间的通信
*       创建一个顾客线程(消费者)：告知老板要的包子的种类和数量，调用wait方法，放弃cpu的执行进入到WAITING状态(无限等待)
        ...
        new Thread(){
            ...
            public void run() {
                ...
                synchronized (obj){
                    ...
                    //调用wait方法，放弃cpu的执行进入到WAITING状态(无限等待)
                    try {   //这里的异常不能throws，因为父类的run方法没有抛异常，只能使用try...catch
                        obj.wait();
